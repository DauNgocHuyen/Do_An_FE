    ...
    <div id="the-footer">
        ...
        <div id="the-footer-container" class="t-flex">
            ...
            <div class="area-4" style="width: 25%; padding: 12px;">
                ...
                <div class="t-color-gray" style="padding: 4.8px 0;">19 Ngo 1, Ao Sen, Ha Dong, Ha Noi</div>
                <div class="t-color-gray" style="padding: 4.8px 0;">Email: dnh2002@gmail.com</div>
                <div class="t-color-gray" style="padding: 4.8px 0; margin-bottom: 16px;">Phone: +84 822 664 236</div>
