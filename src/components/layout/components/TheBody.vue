                    ...
                    <div class="rating-content">
                        ...
                        <div class="rating-right">
                            <div class="rating-right-item">
                                ...
                                <div class="rating-right-item-name">Vinhomes apartment</div>
                            </div>
                            <div class="rating-right-item">
                                <img src="@/assets/imgs/top-rating-6.webp" alt="top rating product">
                                <div class="rating-right-item-name">Cloud Bedroom</div>
                            </div>
                        </div>
                        <!-- End rating right -->
                    </div>
...
export default {
    ...
    data() {
        return {
            ...
            // Top category data
            topCategoryData: [
                {categoryName: 'Wardrobe', imgURL: require('@/assets/imgs/top-category-3.webp')},
                {categoryName: 'Sofa', imgURL: require('@/assets/imgs/top-category-2.webp')},
                {categoryName: 'Dressing table', imgURL: require('@/assets/imgs/top-category-1.webp')},
                {categoryName: 'Wardrobe', imgURL: require('@/assets/imgs/top-category-3.webp')},
                {categoryName: 'Sofa', imgURL: require('@/assets/imgs/top-category-2.webp')},
                {categoryName: 'Dressing table', imgURL: require('@/assets/imgs/top-category-1.webp')}
            ],
            ...
            // Top rating data
            ratingData: [
                {iconStar: true, imgURL: require('@/assets/imgs/top-rating-1.webp'), price: 8990000, productName: 'Mirror'},
                {iconStar: true, imgURL: require('@/assets/imgs/top-rating-2.webp'), price: 199000, productName: 'Sofa'},
                {iconStar: true, imgURL: require('@/assets/imgs/top-rating-3.webp'), price: 5990000, productName: 'Lamp'},
